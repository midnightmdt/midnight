...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeMidnightAmount"))
        settings.setValue("nAnonymizeMidnightAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeMidnightAmount = settings.value("nAnonymizeMidnightAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeMidnightAmount"))
        SoftSetArg("-anonymizemidnightamount", settings.value("nAnonymizeMidnightAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
	...
	case DarksendRounds:
	    ...
	    break;
	case AnonymizeMidnightAmount:
	    nAnonymizeMidnightAmount = value.toInt();
    	    settings.setValue("nAnonymizeMidnightAmount", nAnonymizeMidnightAmount);
 	    emit anonymizeMidnightAmountChanged(nAnonymizeMidnightAmount);
	    break;
        default:
            break;
        }
