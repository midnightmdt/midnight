...
template<typename T1>
inline uint256 HashBmw256(const T1 pbegin, const T1 pend)
{    
...
/** A hasher class for Midnight's 256-bit hash (double SHA-256). */
class CHash256 {
private:
 CSHA256 sha;
public:
...
/** A hasher class for Midnight's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
 CSHA256 sha;
public:
