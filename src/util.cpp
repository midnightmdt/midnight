...
int nAnonymizeMidnightAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Midnight
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Midnight
    // Mac: ~/Library/Application Support/Midnight
    // Unix: ~/.midnight
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Midnight";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "midnight.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "midnightd.pid"));
