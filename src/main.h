...
#define START_MASTERNODE_PAYMENTS_TESTNET 1400000000 
#define START_MASTERNODE_PAYMENTS 1400000000 
...
public:
    ...
    bool ConnectInputs(CTxDB& txdb, MapPrevTx inputs,
                       ...
                       const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags = STANDARD_SCRIPT_VERIFY_FLAGS, bool fMasternodeCheck = false);
...
public:
    ...
    uint256 GetHash() const
    {
        return HashBmw256(BEGIN(nVersion), END(nNonce));
    }
